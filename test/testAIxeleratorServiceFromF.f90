...
use mpi
    ...
    aixelerator = createAIxeleratorServiceDouble_C(model_file_tf, input_shape, num_input_dims, input_data, output_shape, num_output_dims, output_data, batchsize, MPI_COMM_WORLD)
